<template>
  ...
  <v-layout>
    <v-app-bar class="bar">
      ...
      <v-app-bar-title class="hidden-xs">BLOG</v-app-bar-title>
      ...
      <v-spacer></v-spacer>
      <v-switch class="hidden-xs" @click="toggleTheme" :append-icon='icon==true ? "mdi-weather-night"  : "mdi-white-balance-sunny"' ></v-switch>
  ...
  <!-- <v-system-bar class=""  style="height: 75px !important;padding-right: 10px;"> -->
    <v-toolbar class="px-7 pt-2 mt-16" color="orange-darken-3" style="height: auto;padding-right: 10px;">
    <v-avatar style="translate: 0 -20px;"   color="grey"
    rounded="10"
    size="60"
    class="mt-10">
      <img src="" alt="">
         ...
         <v-spacer></v-spacer>
        <v-icon class="mr-4 sh hidden-xs">mdi-magnify</v-icon>
        <v-text-field class="hidden-xs mr-2" variant="outlined"></v-text-field>
    <v-switch class="hidden-sm-and-up" @click="toggleTheme" :append-icon='icon==true ? "mdi-weather-night"  : "mdi-white-balance-sunny"' ></v-switch>
   ...
   <v-bottom-navigation class="hidden-sm-and-up px-6 px-1" ><v-icon class="mr-5 sh">mdi-magnify</v-icon>
    <v-text-field class="" variant="outlined"></v-text-field>
      </v-bottom-navigation>
</v-layout>
    <router-view />
</template>
